        ...
        <div className={styles.ctaActions}>
          ...
          <div className={styles.socialLinks}>
            <div className={styles.socialIconWrapper}>
              <a href="https://www.linkedin.com/in/harshhatela" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
            ...
            <div className={styles.socialIconWrapper}>
              <a href="https://instagram.com/harsh_hatela" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className={styles.socialIconWrapper}>
              <a href="https://github.com/harshhatela" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
